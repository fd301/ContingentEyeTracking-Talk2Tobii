...
%objs = [ LoadOBJFile([basepath 'texblob01.obj']) LoadOBJFile([basepath 'texblob02.obj']) ];
%file1 = '/Users/fd301/Fani/contingent_study/Greebles/Greebles_2_0_symmetric/Greebles-2-0-symmetric/Greebles 3DS/Family1_3DS Folder/f1_13.obj';
file1 = './m1_12_a.obj';
tmpobj = LoadOBJFile(file1);
tmpobj2 = morphGreeble(tmpobj,1);

tmpobj{1} = centreMesh(tmpobj{1},0);
tmpobj2 = centreMesh(tmpobj2,0);

objs = { tmpobj{1} tmpobj2 };

objs{1}.texcoords = objs{1}.vertices;

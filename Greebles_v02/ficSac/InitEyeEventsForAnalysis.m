function [TimeLine, varargout] = InitEyeEventsForAnalysis(inputPathEvents, inputPathEyeTracking, FieldNames, EventNames, subjNo);
%
...
indtmp = find(~BreaksOut);
EyeTrackingData = EyeTrackingData(indtmp,:);

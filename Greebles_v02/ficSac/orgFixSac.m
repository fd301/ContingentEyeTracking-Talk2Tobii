function store = orgFixSac(inputPathEvents, inputPathEyeTracking, FieldNames, imageSize );
...
%     EyeEventSec, EyeEventMsec, MovEventTimFlip...
%     MovEventTimMov, PicEventTimFlip, PicEventIndTex, ...
%     IndexSamples ] = ...
